...
.Multiple Charging Stations connected to CSMS via Local Proxy
image::images/figure_8.svg[Multiple Charging Stations connected to CSMS via Local Proxy]
...
.Multiple Charging Stations connected to CSMS via Local Controller
image::images/figure_9.svg[Multiple Charging Stations connected to CSMS via Local Controller]
...
image::images/figure_10.svg[Multiple non-OCPP Charging Stations connected to CSMS via Local Controller]
...
image::images/figure_11.svg[Smart Charging - DSO control signals to CSMS]
...
.Parallel control by CSMS and EMS
image::images/figure_12.svg[Parallel control by CSMS and EMS]
...
image::images/figure_13.svg[Process from information Model to Messages / schemes]
...
image::images/figure_14.svg[OCPP Information Model: Transactions]
