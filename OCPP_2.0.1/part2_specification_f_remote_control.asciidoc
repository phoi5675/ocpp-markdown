...
|===
s|NOTE |Requirements of previous use case: <<f01_remote_start_transaction_cable_plugin_first,F01 - Remote Start Transaction - Cable Plugin First>>, are also considered relevant for <<f02_remote_start_transaction_remote_start_first,F02 - Remote Start Transaction - Remote Start First>>
|===
