...
|<<diagnosticsstatusnotification,DiagnosticsStatusNotification>>  | |X | | | |
|<<firmwarestatusnotification,FirmwareStatusNotification>>        | |X | | | |
|<<updatefirmware,UpdateFirmware>>                                | |X | | | |
|<<getlocallistversion,GetLocalListVersion>>                      | | |X | | |
...
|<<triggermessage,TriggerMessage>>                                | | | | | | X
|===
