...
|Description 3+d|트랜잭션 시작부터 트랜잭션 종료 시 마지막 측정량까지 <<sampled_data_tx_ended_interval,`SampledDataTxEndedInterval`>>초마다 <<transaction_event_request,TransactionEventRequest>>(<<transaction_event_enum_type,eventType = Ended>>)의 _meterValues_ 요소에 포함될 샘플링된 측정량입니다. +
